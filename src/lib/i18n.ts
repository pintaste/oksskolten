...
const dict = {
  ...
  'provider.deepseek': { ja: 'DeepSeek API', en: 'DeepSeek API', zh: 'DeepSeek API'},
  'provider.mimo': { ja: 'Mimo API', en: 'Mimo API', zh: 'Mimo API'},
  'provider.custom': { ja: 'カスタム API', en: 'Custom API', zh: '自定义 API'},
  ...
  'deepseek.testing': { ja: 'テスト中...', en: 'Testing...', zh: '测试中...'},
  ...
  'mimo.testing': { ja: 'テスト中...', en: 'Testing...', zh: '测试中...'},
  ...
  // Custom API
  'custom.baseUrl': { ja: 'カスタム API サーバー URL', en: 'Custom API Server URL', zh: '自定义 API 服务器 URL'},
  'custom.baseUrlDesc': { ja: 'カスタム API サーバーのアドレスを設定', en: 'Set the custom API server address', zh: '设置自定义 API 服务器地址'},
  'custom.baseUrlPlaceholder': { ja: 'http://localhost:8000', en: 'http://localhost:8000', zh: 'http://localhost:8000'},
  'custom.baseUrlSaved': { ja: 'カスタム API サーバー URL を保存しました', en: 'Custom API server URL saved', zh: '自定义 API 服务器 URL 已保存'},
  'custom.apiKey': { ja: 'API キー（任意）', en: 'API Key (optional)', zh: 'API 密钥（可选）'},
  'custom.apiKeySaved': { ja: 'カスタム API キーを保存しました', en: 'Custom API key saved', zh: '自定义 API 密钥已保存'},
  'custom.apiKeyDeleted': { ja: 'カスタム API キーを削除しました', en: 'Custom API key deleted', zh: '自定义 API 密钥已删除'},
  'custom.displayName': { ja: '表示名', en: 'Display Name', zh: '显示名称'},
  'custom.displayNameDesc': { ja: 'プロバイダーの表示名をカスタマイズ', en: 'Custom display name for this provider', zh: '自定义此提供商的显示名称'},
  'custom.displayNamePlaceholder': { ja: 'My Custom API', en: 'My Custom API', zh: 'My Custom API'},
  'custom.testConnection': { ja: '接続テスト', en: 'Test Connection', zh: '测试连接'},
  'custom.testing': { ja: 'テスト中...', en: 'Testing...', zh: '测试中...'},
  'custom.connected': { ja: '接続成功', en: 'Connected', zh: '已连接'},
  'custom.connectionFailed': { ja: '接続失敗', en: 'Connection failed', zh: '连接失败'},
  'custom.noModels': { ja: 'カスタム API に接続できません', en: 'Cannot connect to Custom API', zh: '无法连接自定义 API'},
